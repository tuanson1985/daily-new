        ...
        <div class="dropdown">
            <div class="topbar-item">
                <div class="dropdown bootstrap-select form-control datatable-input datatable-input-select">
                    <select id="select-client" class="form-control datatable-input datatable-input-select selectpicker select-client" data-live-search="true" title=" {{\Session::has('shop_name') ? \Session::get('shop_id') .' - '. \Session::get('shop_name') : '-- '.__('Tất cả shop').' --'}} " tabindex="null">
                        <option class="bs-title-option" value="">{{__('Tất cả shop')}}</option>
                    ...
                    <div class="dropdown-menu" style="max-height: 241px; overflow: hidden; min-height: 58px;">
                        ...
                        <div class="inner show" role="listbox" id="bs-select-1" tabindex="-1" style="max-height: 171px; overflow-y: auto; min-height: 0px;">
                            <ul class="dropdown-menu inner show" role="presentation" style="margin-top: 0px; margin-bottom: 0px">
                                <li><a role="option" class="dropdown-item" id="bs-select-1-0" tabindex="0"><span class="text">{{__('Tất cả shop')}}</span></a></li>
                                @foreach ($data as $key => $item)
