            ...
            <div class="input-group input-group-sm input-group-solid" style="max-width: 175px">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">
                        {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/General/Search.svg", "svg-icon-md") }}
                    </span>
                </div>
            </div>
        </div>
        <div class="d-flex align-items-center">
            @if (config('layout.subheader.displayDaterangepicker'))
                <a href="#" class="btn btn-light btn-sm font-weight-bold mr-2" id="kt_dashboard_daterangepicker" data-toggle="tooltip" title="Select dashboard daterange" data-placement="left">
                    ...
                    {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/Communication/Chat-check.svg", "svg-icon-sm svg-icon-primary ml-1") }}
                </a>
            @endif
