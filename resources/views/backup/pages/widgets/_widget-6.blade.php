                ...
                <tbody>
                    <tr>
                        <td class="pl-0 py-4">
                            <div class="symbol symbol-50 symbol-light mr-1">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/backend/themes/media/svg/misc/006-plurk.svg') }}" class="h-50 align-self-center"/>
                                </span>
                            </div>
                        </td>
                        <td class="pl-0">
                        ...
                        <td class="text-right pr-0">
                            <a href="#" class="btn btn-icon btn-light btn-sm">
                                {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/General/Settings-1.svg", "svg-icon-md svg-icon-primary") }}
                            </a>
                            <a href="#" class="btn btn-icon btn-light btn-sm mx-3">
                                {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/Communication/Write.svg", "svg-icon-md svg-icon-primary") }}
                            </a>
                            <a href="#" class="btn btn-icon btn-light btn-sm">
                                {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/General/Trash.svg", "svg-icon-md svg-icon-primary") }}
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td class="pl-0 py-4">
                            <div class="symbol symbol-50 symbol-light">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/backend/themes/media/svg/misc/015-telegram.svg') }}" class="h-50 align-self-center"/>
                                </span>
                            </div>
                        </td>
                        <td class="pl-0">
                    ...
                    <tr>
                        <td class="pl-0 py-4">
                            <div class="symbol symbol-50 symbol-light">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/backend/themes/media/svg/misc/003-puzzle.svg') }}" class="h-50 align-self-center"/>
                                </span>
                            </div>
                        </td>
                        <td class="pl-0">
                    ...
                    <tr>
                        <td class="pl-0 py-4">
                            <div class="symbol symbol-50 symbol-light">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/backend/themes/media/svg/misc/005-bebo.svg') }}" class="h-50 align-self-center"/>
                                </span>
                            </div>
                        </td>
                        <td class="pl-0">
                    ...
                    <tr>
                        <td class="pl-0 py-4">
                            <div class="symbol symbol-50 symbol-light">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/backend/themes/media/svg/misc/014-kickstarter.svg') }}" class="h-50 align-self-center"/>
                                </span>
                            </div>
                        </td>
                        <td class="pl-0">
