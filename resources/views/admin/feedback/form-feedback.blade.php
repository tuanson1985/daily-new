...
@section('content')
    ...
    {{Form::open(array('route'=>array('admin.'.$module.'.post_feedback'),'method'=>'POST','id'=>'formMain','enctype'=>"multipart/form-data", 'files' => true))}}
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            @if($errors->has('type'))
                                <div class="form-text text-danger">{{ $errors->first('type') }}</div>
                            @endif
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="title_gen_slug" name="title" value="" autofocus="true"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <textarea id="contents" name="contents" class="form-control ckeditor-basic" ></textarea>
                                ...
                                <div class="sortable grid">
                                    ...
                                    @if (old('files',$data->files??null) != "")
                                        @foreach(explode('|', old('files',$data->files??null)) as $img)
                                            ...
                                            <div class="image-preview-box"  style="width: 200px;height: 200px">
