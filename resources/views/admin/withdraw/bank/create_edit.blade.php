        ...
        <div class="col-lg-9">
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="key" name="key" value="{{ old('key', isset($data) ? $data->key : null) }}" autofocus="true"
                                   placeholder="{{ __('Mã ngân hàng') }}" maxlength="120"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label for="fee_type" class="form-control-label">{{ __('Loại phí') }}</label>
                            {{Form::select('fee_type',config('module.'.$module.'.fee_type'),old('fee_type', isset($data) ? $data->fee_type : null),array('class'=>'form-control'))}}
                            @if($errors->has('fee_type'))
                                <div class="form-control-feedback">{{ $errors->first('fee_type') }}</div>
                            @endif
                        </div>
                    </div>
                    {{-----fee------}}
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label>{{ __('Phí rút tiền') }}</label>
                            <input type="text" id="fee" name="fee" value="{{ old('fee', isset($data) ? $data->fee : 0) }}" autofocus="true"
                                   placeholder="{{ __('Phí rút tiền') }}" maxlength="120"
