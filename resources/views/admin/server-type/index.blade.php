...
@section('content')
    ...
    <div class="modal fade" id="infoModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> {{__('Ghi chú')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        //delete button
        $('.info_toggle').each(function (index, elem) {
            $(elem).click(function (e) {
                e.preventDefault();
                $('#infoModal .id').attr('value', $(elem).attr('rel'));
                $('#infoModal .content-modal').html($(elem).attr('data-content'));
