                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                       ...
                       <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="fullname_display"
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('status',[''=>'-- Tất cả trạng thái --']+config('module.charge_bank.status'),old('status',request('status')),array('id'=>'status','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
        ...
        var KTDatatablesDataSourceAjaxServer = function () {
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    //         '<td colspan="4"><b>Tổng cộng các trang</b></td>' +
                    ...
                    columns: [
                        ...
                        {data: 'total_amount', title: 'Tổng tiền thanh toán'},
                        {data: 'price', title: 'Thực nhận'},
                        {data: 'discount_amount', title: 'Phí thanh toán'},
                        // {
                        //     data: 'gate_id', title: '{{__('Cổng thanh toán')}}',
                        //     render: function (data, type, row) {
                        //         if(row.gate_id == 1){
                        //             return "Alepay";
                        //         }
                        ...
                        // },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                var arrConfig= {!! json_encode(config('module.charge_bank.status')) !!};
                                var temp="";
                                if (row.status == 1) {
                                    ...
                                    temp+="<p><b class='text-dark'>"+ (arrConfig[row.status]??"")+"</b></p>";
                                }
                                return temp;
                            }
                        },
