                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="key_gen_slug" name="key" value="{{ old('key', isset($data) ? $data->key : null) }}" autofocus="true"
                                   placeholder="{{ __('key - để phân biệt theme') }}" maxlength="120"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="content_gen_slug" name="content" value="{{ old('content', isset($data) ? $data->content : null) }}" autofocus="true"
