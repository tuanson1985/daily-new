{{Form::open(array('route'=>array('admin.store-telecom.set-value',$data->id),'method'=>'POST','enctype'=>"multipart/form-data"))}}
...
<div class="modal-body">
    ...
    <div class="dataTables_scrollBody" style=" overflow: auto; width: 100%;">
        <table class="table table-bordered table-list">
            ...
            <tr>
                <th>Mệnh giá</th>
                <th class="text-success">C.K <br/> mặc định (%)</th>
                <th class="text-danger">C.K  <br/>đại lý (%)</th>
            ...
            @if(!is_null($data_telecom_value) && count($data_telecom_value)>0)
                ...
                @foreach($data_telecom_value as $aData)
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" maxlength="4" name="ratio_default[]"  value="{{number_format($aData->ratio_default,1)+0}}"></td>
                        <td><input type="text" class="form-control" maxlength="4" name="ratio_agency[]"  value="{{number_format($aData->ratio_agency,1)+0}}"></td>
                        <td>
    ...
    <div class="form-group {{ $errors->has('password2')? 'has-danger':'' }}">
        ...
        <input type="password" required="required" placeholder="Mật khẩu cấp 2" class="form-control" name="password2" autocomplete="off">
