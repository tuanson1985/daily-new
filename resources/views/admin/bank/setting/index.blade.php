                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('bank_type',array(''=>'-- Tất cả loại --')+config('module.bank.bank_type'),old('status', isset($data) ? $data->bank_type : null),array('id'=>'bank_type','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'bank_type', title: 'Loại',
                            render: function (data, type, row) {
                                if (row.bank_type == 0) {
                                    return "<span class=\"label label-pill label-inline label-center   label-success \">" + "{{config('module.bank.bank_type.0')}}" + "</span>";
                                }
                                else if (row.bank_type == 1) {
                                    return "<span class=\"label label-pill label-inline label-center   label-info\">" + "{{config('module.bank.bank_type.1')}}" + "</span>";
                                }
                                else {
                                    return "Lỗi";
                                }
                        ...
                        {
                            data: 'fee_type', title: 'Phí tính theo',
                            render: function (data, type, row) {
                        ...
                        {
                            data: 'fee', title: 'Phí rút',
                            render: function (data, type, row) {

                                return "<input type='textbox' value='" + row.fee + "' style='width:100px' rel='" + row.id + "' class='price change_price'>";
                            }
                        },

                        {
                            ...
                            render: function (data, type, row) {
                                if (row.status == 0) {
                                    return "<span class=\"label label-pill label-inline label-center   label-danger\">" + "{{config('module.bank.status.0')}}" + "</span>";
                                }
                                else if (row.status == 1) {
                                    return "<span class=\"label label-pill label-inline label-center   label-success\">" + "{{config('module.bank.status.1')}}" + "</span>";
                                }
                                else {
                                    return "Lỗi";
                                }
