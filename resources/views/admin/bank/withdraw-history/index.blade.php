                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="find"
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'holder_name', title: 'Chủ tài khoản'
                        },
                        {
                            data: 'account_number', title: 'Số tài khoản/Tài khoản ví',
                            render: function (data, type, row) {
                                if(row.bank_type==0){
                        ...
                        {
                            data: 'bank_title', title: 'Ngân hàng/Ví',
                            render: function (data, type, row) {
                                return row.bank_title;
                        ...
                        {
                            data: 'description', title: 'Nội dung rút tiền',
                            render: function (data, type, row) {
