...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-success font-weight-bolder">
...
@section('content')
    ...
    <!-- createModal -->
    <div class="modal fade" id="createModal"  role="dialog" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                @include('admin.bank.account.create_edit')
            </div>
        </div>
    </div>
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                if(row.bank.bank_type==0){
                                    return row.account_number;
                                }
                                else if(row.bank.bank_type==1){
                        ...
                        {
                            data: 'bank_id', title: 'Ngân hàng/Ví',
                            render: function (data, type, row) {

                                if (row.bank.bank_type == 0) {
                                    return "<span class=\"m-badge  m-badge--info m-badge--wide\">" + row.bank.title; + "</span>";
                                }
                                else if (row.bank.bank_type == 1) {
                                    return "<span class=\"m-badge  m-badge--success m-badge--wide\">" + row.bank.title + "</span>";
                                }
