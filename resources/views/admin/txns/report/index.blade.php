...
<div class="card card-custom" id="kt_page_sticky_card">
   ...
   <div class="card-body">
      <!--begin: Search Form-->
       <form class="mb-10" action="{{route('admin.txns-report.export-excel')}}" method="POST">
           @csrf
         <div class="row">
            {{--ID--}}
            ...
            <div class="form-group col-12 col-sm-6 col-lg-3">
               <div class="input-group">
                  ...
                  <input type="text" class="form-control datatable-input" name="username" id="username" value="{{request('username')}}"
            ...
            <div class="form-group col-12 col-sm-6 col-lg-3">
               <div class="input-group">
                  ...
                  <input type="text" name="email" class="form-control datatable-input" id="email" value="{{request('email')}}"
            ...
            <div class="form-group col-12 col-sm-6 col-lg-3">
               <div class="input-group">
                  ...
                  {{Form::select('account_type',[''=>'-- Loại tài khoản --']+config('module.user.account_type'),old('account_type',request('account_type')),array('id'=>'account_type','class'=>'form-control datatable-input',))}}
               </div>
            </div>
            {{--status--}}
            <div class="form-group col-12 col-sm-6 col-lg-3">
       ...
       var initTable1 = function () {
           ...
           datatable = $('#kt_datatable').DataTable({
               ...
               columns: [
                   ...
                   {data: 'order_id', title: 'Đơn hàng'},//1
                   @endif
                   ...
                   {data: 'trade_type', title: '{{__('Loại giao dịch')}}', render: function (data, type, row) {
                   ...
                   {data: 'updated_at', title: '{{__('Thời gian')}}',visible: false},//12
                   @if(Auth::user()->id == 5551)
                   {data: 'updated_at', title: 'Thời gian khởi tạo'},//1
                   @endif
