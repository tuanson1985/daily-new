...
@section('content')
    ...
    {{Form::open(array('route'=>array('admin.post_money'),'method'=>'POST','id'=>'formMain','enctype'=>"multipart/form-data"))}}
...
{{--                                    {{Form::select('shop_id',$shop,old('field', request('shop_id')),array('id'=>'shop_id','class'=>'form-control input-group-text'))}}--}}
{{--                                </div>--}}
                                <div class="input-group-prepend">
                                ...
                                <input type="hidden" name="id" id="id"
                                       value="{{ old('id', request('id') ? request('id') : null) }}"
                                       class="form-control" placeholder="Tìm kiếm...">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#btnChecker").click(function () {
                ...
                $.get('{{route('admin.get_user_to_money')}}' + '?username=' + ur + '&field=' + field,
