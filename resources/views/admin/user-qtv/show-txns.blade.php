...
{{--    <label class="col-sm-4 col-form-label">Số dư tài khoản người nhận</label>--}}
{{--    <div class="col-sm-8">--}}
{{--        <div class="input-group">--}}
{{--            <input type="text" id="balance" readonly--}}
{{--                   class="form-control m-input m-input--air price"--}}
{{--                   name="input_withdraw_max"--}}
{{--                   value="{{ number_format(old('balance', isset($user) ? $user->balance : null)) }}"--}}
{{--                   placeholder="Số dư tài khoản người nhận">--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
