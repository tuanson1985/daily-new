...
{{--                        {{dd($data['user']->google2fa_enable)}}--}}
                        @if(!$data['user']->google2fa_secret)
                            <form class="form-horizontal" method="POST" action="{{ route('admin.generate2faSecret') }}">
                                {{ csrf_field() }}
                        ...
                        @elseif(!$data['user']->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('admin.enable2fa') }}">
                                {{ csrf_field() }}
                        ...
                        @elseif($data['user']->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('admin.disable2fa') }}">
