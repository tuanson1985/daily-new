                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="giftcode" value="{{request('giftcode')}}"
                                   placeholder="{{__('Mã code')}}">
                        </div>
                    </div>
                    {{--status--}}
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('status',[''=>'-- Tất cả trạng thái --']+config('module.gift-code.status'),old('status',request('status')),array('id'=>'status','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
                    {{--started_at--}}
                    <div class="form-group col-12 col-sm-6 col-lg-3">
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    "drawCallback": function (settings) {
                        ...
                        //     '<td colspan="5"><b>Tổng cộng các trang</b></td>' +
                    ...
                    columns: [
                        ...
                        {data: 'id', title: 'ID'},
                        {data: 'user', title: '{{__('Tài khoản')}}'},
                        {data: 'voucher.title', title: '{{__('Chiến dịch')}}'},
                        {data: 'voucher.code', title: '{{__('Mã code')}}'},
                        {data: 'voucher.type', title: '{{__('Loại phần thưởng')}}'},
                        {data: 'discount', title: '{{__('Thực nhận')}}'},
                        {data: 'created_at', title: '{{__('Ngày nhận')}}'},
                    ],
