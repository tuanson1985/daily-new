        ...
        <div class="col-lg-9">
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="title_gen_slug" name="title" value="{{ old('title', isset($data) ? $data->title : null) }}" autofocus="true"
                                   placeholder="{{ __('Tên loại tích điểm') }}" maxlength="120"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label>{{ __('Số điểm nhận được từ') }}</label>
                            <input type="text" id="totalitems" name="totalitems" value="{{ old('totalitems', isset($data) ? $data->totalitems : null) }}" autofocus="true"
                                   placeholder="{{ __('Số điểm nhận được từ') }}" maxlength="120"
                                   class="form-control {{ $errors->has('totalitems') ? ' is-invalid' : '' }}">
                            @if ($errors->has('totalitems'))
                                <span class="form-text text-danger">{{ $errors->first('totalitems') }}</span>
                            @endif
                        </div>
                    </div>
                    {{-----max_use------}}
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label>{{ __('Số điểm nhận được đến') }}</label>
                            <input type="text" id="totalviews" name="totalviews" value="{{ old('totalviews', isset($data) ? $data->totalviews : null) }}" autofocus="true"
                                   placeholder="{{ __('Số điểm nhận được đến') }}" maxlength="120"
                                   class="form-control {{ $errors->has('totalviews') ? ' is-invalid' : '' }}">
                            @if ($errors->has('totalviews'))
                                <span class="form-text text-danger">{{ $errors->first('totalviews') }}</span>
                            @endif
                        </div>
                    </div>
                    {{-- sticky --}}
                    <div class="form-group row">
                        <div class="col-12 col-md-6">
                            <label class="form-control-label">{{ __('Loại tích điểm') }}</label>
                            {{Form::select('sticky',config('module.'.$module.'.sticky'),old('sticky', isset($data) ? $data->sticky : null),array('class'=>'form-control sticky-gift'))}}
                            @if($errors->has('sticky'))
                                <div class="form-control-feedback">{{ $errors->first('sticky') }}</div>
                            @endif
                        </div>
                    </div>
                    {{-- position --}}
                    <div class="form-group row">
                        <div class="col-12 col-md-6">
                            <label class="form-control-label">{{ __('Điều kiện tích điểm') }}</label>
                            {{Form::select('position',config('module.'.$module.'.condition'),old('position', isset($data) ? $data->position : null),array('class'=>'form-control position-gift'))}}
