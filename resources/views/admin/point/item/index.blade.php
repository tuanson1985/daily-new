            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'totalitems', title: '{{__('Số điểm nhận được từ')}}'},
                        {data: 'totalviews', title: '{{__('Số điểm nhận được đến')}}'},
                        {
                            data: 'position', title: '{{__('Điều kiện nhận tích điểm')}}',
                            render: function (data, type, row) {

                                if (row.position == 0) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.0')}}" + "</span>";
                                } else if (row.position == 1) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.1')}}" + "</span>";
                                }else if (row.position == 2) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.2')}}" + "</span>";
                                }
                                else if (row.position == 3) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.3')}}" + "</span>";
                                }
                                else if (row.position == 4) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.4')}}" + "</span>";
                                }
                                else if (row.position == 5) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.5')}}" + "</span>";
                                }
                                else if (row.position == 6) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.6')}}" + "</span>";
                                }
                                else if (row.position == 7) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.7')}}" + "</span>";
                                }
                                else {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.condition.0')}}" + "</span>";
                                }
                        ...
                        {
                            data: 'sticky', title: '{{__('Loại tích điểm')}}',
                            render: function (data, type, row) {

                                if (row.sticky == 1) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \">" + "{{config('module.'.$module.'.sticky.1')}}" + "</span>";
                                } else if (row.sticky == 2) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2 label-success \">" + "{{config('module.'.$module.'.sticky.2')}}" + "</span>";
                                } else {
                                    return "<span class=\"label label-pill label-inline label-center mr-2 label-success \">Không xác định</span>";
                                }
