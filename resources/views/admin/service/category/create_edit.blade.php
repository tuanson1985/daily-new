                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6 col-md-6">
                            ...
                            <input type="text" id="title_gen_slug" name="account_fake" value="{{ old('account_fake', isset($data) ? $data->account_fake : null) }}" autofocus
                    ...
                    @php
                        $params_error = null;
                        if(isset($data)){
                            if (isset($data->params_error)){

                                if ($data->params_error[0] == null){

                                }else{
                                    $params_error = json_decode($data->params_error);
                                }

                            }
                        }
                    @endphp
                    @if(!empty($params_error))
                        <div class="form-group row">
                            <div class="col-md-12" style="padding-top: 8px;padding-bottom: 8px">
                                <label for="locale">{{ __('Danh sách lỗi') }}</label>
                                <div class="row data__redirect">
                                    @foreach($params_error??[] as $item)
                                        <div class="col-md-12" style="padding-left: 0;padding-right: 0">
                                        <div class="row" style="width: 100%;margin: 0 auto">
                                            <div class="col-6" style="position: relative;padding-top: 8px">
                                                <input type="text" class="form-control" name="params_error[]" value="{{ $item }}">
                                                <i class="la la-trash thungrac" style="position: absolute;top: 8px;right: -12px;font-size: 18px;cursor: pointer"></i>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                        ...
                        <div class="col-md-12" style="padding-top: 8px;padding-bottom: 8px">
                            ...
                            <div class="row data__redirect">
                                ...
                                <div class="col-md-12" style="padding-left: 0;padding-right: 0">
                                    <div class="row" style="width: 100%;margin: 0 auto">
                                        <div class="col-6" style="position: relative;padding-top: 8px">
                                            <input type="text" class="form-control" name="params_error[]" value="">
                                            <i class="la la-trash thungrac" style="position: absolute;top: 8px;right: -12px;font-size: 18px;cursor: pointer"></i>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group row" style="margin-top: 24px">
                        <div class="col-auto ml-auto">
                            <button type="button" class="btn btn-primary btn__redirect">Thêm Lỗi</button>
                        </div>
                    </div>
