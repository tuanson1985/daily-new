                    ...
                    columns: [
                        ...
                        { data: 'status',title:'Trạng thái', orderable: false, searchable: false,
                            render: function ( data, type, row ) {
                                ...
                                if(row.status==2){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-danger\"> "+'{{config('module.status-bot.2')}}'+" </span>";
                                }

                                if(row.status==0){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-danger\"> "+'{{config('module.status-bot.0')}}'+" </span>";
                                }
                                if(row.status==3){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-danger\"> "+'{{config('module.status-bot.3')}}'+" </span>";
                                }
                                if(row.status==6){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-info\"> Bot check thông tin </span>";
                                }
                                return '';
                            }
                        },
