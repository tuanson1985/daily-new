...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="{{route('admin.nrogem-info-bot.create')}}" type="button"  class="btn btn-success font-weight-bolder">
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.nrogem-info-bot.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'gem',title:'Tiền (Ingame)'},
                        { data: 'item',title:'Item'},
                        { data: 'map',title:'Vị trị đứng'},
                        { data: 'bag',title:'Hành trang'},
                        { data: 'created_at',title:'Cập nhật lúc',
                            render: function ( data, type, row ) {
                        ...
                        { data: 'status',title:'Trạng thái', orderable: false, searchable: false,
                            render: function ( data, type, row ) {
                                if(row.status+""=="on"){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-success\">"+"On"+"</span>";
                                }
                                else{
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-danger\">"+"Off"+"</span>";
                                }
                            }
                        },
