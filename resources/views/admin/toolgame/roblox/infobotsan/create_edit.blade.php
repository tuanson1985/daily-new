        ...
        <div class="col-lg-9">
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label style="font-weight: 900">{{ __('Mật khẩu') }}</label>
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label style="font-weight: 900">{{ __('Tỷ giá') }}</label>
                            <input type="text" id="rate" name="rate" value="{{ old('rate', isset($data) ? $data->rate : null) }}"
                                   placeholder="{{ __('Tỷ giá') }}" maxlength="120"
                                   class="form-control {{ $errors->has('ver') ? ' is-invalid' : '' }}">
                            @if ($errors->has('rate'))
                                <span class="form-text text-danger">{{ $errors->first('rate') }}</span>
                            @endif
                        </div>
                    </div>
