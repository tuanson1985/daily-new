...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="{{route('admin.roblox-info-bot-san.create')}}" type="button"  class="btn btn-success font-weight-bolder">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="acc"
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('server',[''=>'-- Tất cả server --']+[
                                        '1'=>'Server 1',
                                        '2'=>'Server 2',
                                        '3'=>'Server 3',
                                        '4'=>'Server 4',
                                        ...
                                        '7'=>'Server 7',
                                        '8'=>'Server 8',
                                        ],old('status', isset($data) ? $data->status : null),array('id'=>'status','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('status',[''=>'-- Tất cả trạng thái --']+config('module.status-bot'),old('status', isset($data) ? $data->status : null),array('id'=>'status','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.roblox-info-bot.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'id', title: 'ID'},
                        { data: 'acc',title:'Tài khoản'},
                        { data: 'coin',title:'Số dư'},
                        {
                            data: 'price', title: 'Giá tiền',visible: false,
                            render: function (data, type, row) {
                        ...
                        {
                            data: 'rate', title: 'Tỷ giá',visible: false,
                            render: function (data, type, row) {

                                return row.rate??'';
                            }
                        },
                        { data: 'id_pengiriman',title:'ID lô hàng'},
                        {
                            data: 'get_nick_detail', title: 'TG lấy nick',
                            render: function (data, type, row) {

                                return row.get_nick_detail??'';
                            }
                        },
                        {
                            data: 'defragment_type', title: 'TG trả nick',
                            render: function (data, type, row) {

                                return row.defragment_type??'';
                            }
                        },
                        {
                            data: 'defragment', title: 'TG dồn nick',
                            render: function (data, type, row) {

                                return row.defragment??'';
                            }
                        },
                        { data: 'updated_at',title:'Cập nhật lúc',
                            render: function ( data, type, row ) {
                        ...
                        { data: 'status',title:'Trạng thái', orderable: false, searchable: false,
                            render: function ( data, type, row ) {
                                if(row.status==1){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-success\"> "+'{{config('module.status-bot.1')}}'+" </span>";
                                }
                                if(row.status==2){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-info\"> "+'{{config('module.status-bot.2')}}'+" </span>";
                                }

                                if(row.status==0){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-info\"> "+'{{config('module.status-bot.0')}}'+" </span>";
                                }
                                if(row.status==3){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-info\"> "+'{{config('module.status-bot.3')}}'+" </span>";
                                }
                                if(row.status==6){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-primary\"> Bot check thông tin </span>";
                                }
                                return '';
                            }
                        },
