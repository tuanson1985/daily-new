...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="{{route('admin.roblox-info-bot.create')}}" type="button"  class="btn btn-success font-weight-bolder">
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'uid',title:'User id'},
                        { data: 'id_pengiriman',title:'ID lô hàng'},
                        {
                            data: 'defragment', title: 'Số robux dồn',
                            render: function (data, type, row) {
