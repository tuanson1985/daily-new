...
@section('content')
    ...
    <div class="card card-custom" id="kt_page_sticky_card">
        ...
        <div class="card-body">
            <!--begin: Search Form-->
            <form class="mb-10" action="{{route('admin.nrocoin-export.index')}}" method="post">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('status_order',[''=>'-- Tất cả trạng thái (Order) --']+config('module.service-purchase.status'),old('status_order',request('status_order')),array('id'=>'status_order','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('status',[''=>'-- Tất cả trạng thái (Tool) --']+ ['danhan'=>"Đã nhận","chuanhan"=>"Chưa nhận","dahuybo"=>"Đã hủy bỏ",'danap'=>"Đã nạp"],old('status',request('status')),array('id'=>'status','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
                        Số thỏi vàng bán: <b id="total_gold">0</b> - Số thỏi vàng nạp: <b id="total_gold_nap">0</b>
                    </div>


                    <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
                        Số vàng bán: <b id="total_coin">0</b> - Số vàng nạp: <b id="total_coin_nap">0</b>
                    </div>
                    <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'thoivangtruoc', title: '{{__('Thỏi vàng trước')}}',render: function (data, type, row) {
                                return number_format(row.thoivangtruoc,',');
                            }
                        },
                        {
                            data: 'thoivangsau', title: '{{__('Thỏi vàng sau')}}',render: function (data, type, row) {
                                return number_format(row.thoivangsau,',');
                            }
                        },
                        ...
                        {
                            data: 'money', title: '{{__('Số vàng')}}',render: function (data, type, row) {
                                var temp="";
                                if(row.status=='danap'){
                                    temp="<span class=\"c-font-bold text-success\">+"+number_format(row.money,',')+"</span>";
                                }
                                else{
                                    temp="<span class=\"c-font-bold text-danger\">-"+number_format(row.money,',')+"</span>";
                                }
                                return temp;
                            }
                        },
                        ...
                        },
                        {
                            data: 'status', title: '{{__('Trạng thái tool')}}',render: function (data, type, row) {
                                ...
                                var temp="";
                                if(row.status=='danhan'){
                                    temp="<b class='text-success'>Đã nhận</b>";
                                }
                                else if(row.status=='danap'){
                                    temp="<b class='text-info'>Đã nạp</b>";
                                }
                                else if(row.status=='chuanhan'){
                                    temp="<b class='text-warning'>Chưa nhận</b>";
                                }
                                else if(row.status=='dahuybo'){
                                    temp="<b class='text-danger'>Đã hủy bỏ</b>";
                                }
                                return temp;
                            }
                        },
