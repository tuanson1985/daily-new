...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="{{route('admin.nrocoin-info-bot.create')}}" type="button"  class="btn btn-success font-weight-bolder">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="ver"
                                   placeholder="{{__('Ver')}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('status',[''=>'-- Tất cả trạng thái --']+['on'=>'on','off'=>'off'],old('status', isset($data) ? $data->status : null),array('id'=>'status','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.nrocoin-info-bot.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'coin',title:'Tiền (Ingame)',
                            render: function ( data, type, row ) {
                                return "<span>"+ parseFloat(row.coin).toLocaleString() +"</span>";
                            }
                        },
                        { data: 'thoivang',title:'Thỏi vàng',
                            render: function ( data, type, row ) {
                                return "<span class='ticketcoin' data-ticketcoin='"+row.thoivang+"'>"+row.thoivang+"</span>";
                            }
                        },
                        { data: 'thoivang',title:'Tổng vàng',
                            render: function ( data, type, row ) {
                                return "<span class='ticketcoin'>"+ (parseFloat(row.coin) + (parseFloat(row.thoivang)*37000000)).toLocaleString() +"</span>";
                            }
                        },
                        ...
                        { data: 'active',title:'Trạng thái', orderable: false, searchable: false,
                            render: function ( data, type, row ) {
                                if(row.active=="on"){
                                    return  "<span class=\"label label-pill label-inline label-center mr-2  label-success\">"+row.active+"</span>";
                                }
                                else{
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-danger\">"+row.active+"</span>";
                                }
                            }
                        },
