                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="status" id="status">
                                ...
                                <option value="gandonchobot"> Đã gán đơn cho bot </option>
                                <option value="recharge"> Kết nối NCC thất bại </option>
                                <option value="danhan"> Đã nhận </option>
                                <option value="dahuybo"> Hủy </option>
                            </select>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="psxModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.toolgame.roblox-anime-defender',0) }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-submit-ajax">
                    @csrf
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    buttons: [
                        ...
                        {
                            text: '<i class="m-nav__link-icon la la-compress"></i> Chuyển trạng thái roblox anime',
                            action: function (e) {
                                e.preventDefault();
                                var allSelected = '';
