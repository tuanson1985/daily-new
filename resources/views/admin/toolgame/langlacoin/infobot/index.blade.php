...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="{{route('admin.langlacoin-info-bot.create')}}" type="button"  class="btn btn-success font-weight-bolder">
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.langlacoin-info-bot.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'status',title:'Trạng thái', orderable: false, searchable: false,
                            render: function ( data, type, row ) {
                                if(row.active=="on"){
                                    return  "<span class=\"m-badge  m-badge--success m-badge--wide\">"+"{{config('constants.module.game.status.1')}}"+"</span>";
                                }
                                else{
                                    return "<span class=\"m-badge  m-badge--danger m-badge--wide\">"+"{{config('constants.module.game.status.0')}}"+"</span>";
                                }
                            }
                        },
