        ...
        <div class="card-body">
            ...
            <form class="mb-10">
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="ver" value="{{request('ver')}}"
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="server" value="{{request('server')}}"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
                        Số bạc bán: <b id="total_coin">0</b> - Số bạc nạp: <b id="total_coin_nap">0</b>
                    </div>
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'money', title: '{{__('Số bạc')}}',render: function (data, type, row) {
                                var temp="";
                                if(row.status=='danap'){
                        ...
                        {
                            data: 'status', title: '{{__('Trạng thái')}}',render: function (data, type, row) {
