                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label>{{ __('Ver') }}</label>
                            <input type="text" id="ver_gen_slug" name="ver" value="{{ old('ver', isset($data) ? $data->ver : null) }}" autofocus="true"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="server_gen_slug" name="server" value="{{ old('server', isset($data) ? $data->server : null) }}" autofocus="true"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text"  name="uname" value="{{ old('uname', isset($data) ? $data->uname : null) }}"
                                   placeholder="{{ __('Tên tài khoản') }}"
                                   class="form-control {{ $errors->has('uname') ? ' is-invalid' : '' }}">
                            @if ($errors->has('uname'))
                                <span class="form-text text-danger">{{ $errors->first('uname') }}</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="pass_gen_slug" name="pass" value="{{ old('pass', isset($data) ? $data->pass : null) }}" autofocus="true"
