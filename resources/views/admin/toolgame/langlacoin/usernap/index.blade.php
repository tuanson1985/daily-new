...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        ...
        <div class="btn-group">
            <a href="{{route('admin.langlacoin-usernap.create')}}" type="button"  class="btn btn-success font-weight-bolder">
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.langlacoin-usernap.destroy',0),'class'=>'form-horizontal','id'=>'form-delete','method'=>'DELETE'))}}
