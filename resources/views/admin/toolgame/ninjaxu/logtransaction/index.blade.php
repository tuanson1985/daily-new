...
@section('content')
    ...
    <div class="card card-custom" id="kt_page_sticky_card">
        ...
        <div class="card-body">
            <!--begin: Search Form-->
            <form class="mb-10" action="{{route('admin.ninjaxu-export.index')}}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    {{--ID--}}
            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'coin', title: '{{__('Số vàng')}}',render: function (data, type, row) {
                                var temp="";
                                if(row.status=='danap'){
                                    temp="<span class=\"c-font-bold text-success\">+"+number_format(row.coin,',')+"</span>";
                                }
                                else{
                                    temp="<span class=\"c-font-bold text-danger\">-"+number_format(row.coin,',')+"</span>";
                                }
                                return temp;
                            }
                        },
                        ...
                        {
                            data: 'created_at', title: '{{__('Thời gian cập nhật')}}',render: function (data, type, row) {
                                return row.created_at;
                            }
                        },
                        {
                            data: 'updated_at', title: '{{__('Thời gian tạo')}}',render: function (data, type, row) {
