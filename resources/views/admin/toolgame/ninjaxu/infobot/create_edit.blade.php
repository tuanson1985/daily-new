                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="pass_gen_slug" name="pass" value=""
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            <label>{{ __('Tên tài khoản') }}</label>
                            <input type="text" id="acc_gen_slug" name="igbanxu" value="{{ old('igbanxu', isset($data) ? $data->igbanxu : null) }}"
                                   placeholder="{{ __('Tên nhân vật') }}"
                                   class="form-control {{ $errors->has('acc') ? ' is-invalid' : '' }}">
                            @if ($errors->has('igbanxu'))
                                <span class="form-text text-danger">{{ $errors->first('igbanxu') }}</span>
                            @endif
                        </div>
                    </div>
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-12">
                            <label for="active" class="form-control-label">{{ __('Trạng thái') }}</label>
                            {{Form::select('active',['on'=>'on','off'=>'off'] ,old('active', isset($data) ? $data->active : null),array('class'=>'form-control'))}}
