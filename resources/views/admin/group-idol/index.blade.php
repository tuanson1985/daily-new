...
@section('action_area')
    <div class="d-flex align-items-center text-right">
        <div class="btn-group">
            ...
            <div class="btn-group">
                <a href="{{route('admin.article-category.create')}}" type="button"  class="btn btn-success font-weight-bolder">
                    <i class="fas fa-plus-circle icon-md"></i>
                    {{__('Thêm mới')}}
                </a>
            </div>
...
@section('content')
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.article-category.destroy',0),'class'=>'form-horizontal','method'=>'DELETE'))}}
        ...
        $(function () {
            $('.dd').nestable({
                dropCallback: function (details) {
                    ...
                    $.post('{{route('admin.article-category.order')}}',
                        {
                            _token:'{{ csrf_token() }}',
