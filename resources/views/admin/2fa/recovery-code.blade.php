    ...
    <div class="text-center">
        <div class="row" id="body-code">
            <div class="col-md-4 m-auto col-sm-12">
                <h4>Bạn đang ở trang lấy mã khôi phục Google Authenticator, mã khôi phục này chỉ được lấy một lần</h4>
                <form method="POST" id="form-setup" action="{{ route('admin.security-2fa.recovery-code') }}">
                    @csrf
                    ...
                    if(data.status == 1){
                        ...
                        swal()
                            function swal(){
                                Swal.fire({
                                    title: 'Thông báo',
                                    html: '<p>Mã code khôi phục của bạn là: </p><h2><b>'+data.two_factor_recovery_codes+'</b> <span class="copyData" data-copy="'+data.two_factor_recovery_codes+'"><i class="flaticon2-copy"></i></span></h2>. <p>Vui lòng lưu trữ mã này để khôi phục ứng dụng google 2FA khi cần thiết.</p>',
                                    icon: 'success',
