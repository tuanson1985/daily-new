            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'params', title: '{{__('Số user top')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field acc_show_num' data-field='acc_show_num' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.acc_show_num!=null?row.params.acc_show_num:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Số lượt chơi từ')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field play_num_from' data-field='play_num_from' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.play_num_from!=null?row.params.play_num_from:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Số lượt chơi đến')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field play_num_to' data-field='play_num_to' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.play_num_to!=null?row.params.play_num_to:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Người đang chơi từ')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field user_num_from' data-field='user_num_from' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.user_num_from!=null?row.params.user_num_from:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Người đang chơi đến')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field user_num_to' data-field='user_num_to' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.user_num_to!=null?row.params.user_num_to:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Lượt chơi gần đây')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field play_num_near' data-field='play_num_near' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.play_num_near!=null?row.params.play_num_near:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Trúng giải đặc biệt từ')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field special_num_from' data-field='special_num_from' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.special_num_from!=null?row.params.special_num_from:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Trúng giải đặc biệt đến')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field special_num_to' data-field='special_num_to' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.special_num_to!=null?row.params.special_num_to:''):'') + "' style='width:55px'>";
                            }
                        },
                        {
                            data: 'params', title: '{{__('Giải thưởng còn lại')}}',
                            render: function (data, type, row) {
                                return "<input class='update_field gift_num_exist' data-field='gift_num_exist' data-required='0' data-id='"+row.id+"' type='number' value='" + (row.params!=null?(row.params.gift_num_exist!=null?row.params.gift_num_exist:''):'') + "' style='width:55px'>";
                            }
                        },
                ...
                datatable.on("change", ".update_field", function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '{{route('admin.minigame-seedingpackage.updatefield')}}',
                        data: {
                            '_token':'{{csrf_token()}}',
                            'field':field,
                            'id':id,
