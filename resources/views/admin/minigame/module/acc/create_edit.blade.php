                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-4 col-md-4">
                            <label for="idkey" class="form-control-label">{{ __('Loại game') }}</label>
                            {{Form::select('idkey',[''=>'-- Không chọn --']+(config('module.minigame.game_type')??[]) ,old('idkey', isset($data) ? $data->idkey : null),array('class'=>'form-control'))}}
                            @if($errors->has('idkey'))
