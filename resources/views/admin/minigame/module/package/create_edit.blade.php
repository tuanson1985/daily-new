                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                            <select class="form-control" name="sticky">
                                ...
                                @if(isset($data) && isset($data->sticky))
                                    @if($data->sticky == 1)
                                        <option selected value="1"> SMS </option>
                                        <option value="2"> GARENA </option>
                                    @else
                                        <option value="1"> SMS </option>
                                        <option selected value="2"> GARENA </option>
                                    @endif
                                @else
                                    <option value="1"> SMS </option>
                                    <option value="2"> GARENA </option>
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="price_old_face" value="{{ old('price_old', isset($data) ? str_replace(',','.',number_format($data->price_old)): null) }}" autofocus="true"
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="price_face" value="{{ old('price', isset($data) ? str_replace(',','.',number_format($data->price)) : null) }}" autofocus="true"
