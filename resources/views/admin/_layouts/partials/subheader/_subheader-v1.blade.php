                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2">
                    <li class="breadcrumb-item">
                        <a href="{{route('admin.index')}}">
                            <i class="la la-home text-muted icon-md"></i>&nbsp Dashboard
                        </a>
                    </li>
...
{{--                    {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/Files/File-plus.svg", "svg-icon-success svg-icon-2x") }}--}}
{{--                </a>--}}
