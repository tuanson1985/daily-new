...
<div class="topbar">
    ...
    <div class="dropdown" id="kt_quick_search_toggle">
       ...
       <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
          @include('admin._layouts.partials.extras.dropdown._search-dropdown')
       </div>
    </div>
    @endif
    @endif
    ...
    <div class="dropdown">
       ...
       <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
          <form>
             @include('admin._layouts.partials.extras.dropdown._notifications')
          </form>
       </div>
    </div>
    @endif
    ...
    <div class="dropdown">
       ...
       {{-- Dropdown --}}
       <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
          @include('admin._layouts.partials.extras.dropdown._quick-actions')
       </div>
    </div>
    @endif
    @endif
    ...
    <div class="dropdown">
       ...
       <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
          <form>
             @include('admin._layouts.partials.extras.dropdown._cart')
          </form>
       </div>
    </div>
    @endif
...
{{--    <a href="/admin/git-pull" class="btn btn-light btn-text-success btn-hover-text-success font-weight-bold dongbogit" >Đồng bộ git</a>--}}
{{--    @endif--}}
{{--    @include('admin._layouts.partials.extras._client')--}}
{{--    @include('admin._layouts.partials.extras._cache')--}}
{{--    @include('admin._layouts.partials.extras._redirect')--}}
    ...
    <div class="dropdown">
       <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
          <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
             <img class="h-20px w-20px rounded-sm" src="{{ asset('assets/backend/themes/media/svg/flags/226-united-states.svg') }}" alt=""/>
          </div>
       </div>
       <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
          @include('admin._layouts.partials.extras.dropdown._languages')
       </div>
    </div>
    @endif
    {{-- User --}}
    ...
    <div class="dropdown">
       ...
       <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
          @include('admin._layouts.partials.extras.dropdown._user')
       </div>
    </div>
    @endif
    @endif
