...
<div class="aside aside-left {{ Metronic::printClasses('aside', false) }} d-flex flex-column flex-row-auto"
    ...
    <div class="brand flex-column-auto {{ Metronic::printClasses('brand', false) }}" id="kt_brand">
        <div class="brand-logo">
            <a href="{{ route('admin.index') }}" style="font-size: 18px;text-transform: uppercase;color: white !important;position: relative">
                {{--Admin Panel--}}
        ...
        @if (config('layout.aside.self.minimize.toggle'))
            <button class="brand-toggle btn btn-sm px-0" id="kt_aside_toggle">
                {{ Metronic::getSVG("assets/backend/themes/media/svg/icons/Navigation/Angle-double-left.svg", "svg-icon-xl") }}
            </button>
        @endif
    ...
    <div class="row" style="margin: 0 auto;width: 100%" id="fakemenuadmin">
        ...
        <div class="col-md-12" style="padding: 0 12px">
            <input id="search_aside_menu" style="height: 30px" type="text" autofocus="false" class="form-control search_aside_menu" placeholder="Tìm kiếm" name="search_aside_menu" style="position: relative">
