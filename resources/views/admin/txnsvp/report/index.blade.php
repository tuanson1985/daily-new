...
@section('content')
    ...
    <div class="card card-custom" id="kt_page_sticky_card">
        ...
        <div class="card-body">
            <!--begin: Search Form-->
            <form class="mb-10" action="{{route('admin.txnsvp-export.index')}}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    {{--ID--}}
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('trade_type',[''=>'-- Tất cả giao dịchi --']+config('module.txnsvp.trade_type'),old('trade_type',request('trade_type')),array('id'=>'trade_type','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
                    {{--is_add--}}
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if ( auth()->user()->can('txnsvp-export'))
