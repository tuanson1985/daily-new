...
@section('content')
                    ...
                    <div class="well">
                        <div class="lead text-right">
                            <div class="" style="float: right">
                                ...
                                <a  href="{{ ($_GET['trashed']??null) == 1? url()->current(): '?trashed=1' }}" class="btn btn-secondary"  >
                                    {{ ($_GET['trashed']??null) == 1? 'Không hiển thị danh mục xoá': 'Hiển thị danh mục xoá' }}
                                </a>
                            </div>
                        ...
                        <div class="dd" id="nestable">
                            @include('admin.acc.widget.category-list', ['data' => $data, 'module' => 'acc_provider', 'parent' => 0])
                        </div>
                        {{ Form::close() }}
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array("admin.acc.property.edit", ['property', 0, 0]),'class'=>'form-horizontal','method'=>'DELETE'))}}
        ...
        $(function () {
            $('.dd').nestable({
                dropCallback: function (details) {
                    ...
                    $.post('{{route('admin.acc.property.order')}}',
                        {
                            _token:'{{ csrf_token() }}',
