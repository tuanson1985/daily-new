...
use CKSource\CKFinder\Backend\BackendFactory as BaseBackendFactory;
...
class BackendFactory
{
    ...
    protected function registerDefaultAdapters()
    {
        ...
        $this->registerAdapter('s3', function ($backendConfig) {
            ...
            $clientConfig['endpoint'] = env('AWS_ENDPOINT');
            ...
            $contentText =  $txt = '11111111111111';
...
//            dd($this->createBackend($backendConfig, new AwsS3Adapter($client, $backendConfig['bucket'], $prefix), $filesystemConfig));
