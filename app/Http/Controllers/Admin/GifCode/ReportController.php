...
class ReportController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->middleware('permission:gift-code-report-list');
        $this->middleware('permission:gift-code-report-show', ['only' => ['show']]);


        $this->page_breadcrumbs[] = [
            'page' => route('admin.gift-code-report.index'),
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax) {
            ...
            return \datatables()->eloquent($datatable)
                ...
                ->editColumn('voucher.type', function ($data) {
                    return config('module.gift-code.type.'.$data->voucher->type);
                })
        ...
        return view('admin.gift-code.report.index')
            ->with('module', null)
