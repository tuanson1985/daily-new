...
namespace App\Http\Controllers\Admin\ServerCategory;
...
class ItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $datatable=Server_Category::where('module','catalog')->where('status','<>','0');
...
//        }
        ...
        $dataCategory = Server_Category::where('module','catalog')->where('status','<>','0')->get();
    ...
    public function edit(Request $request, $id)
    {
        ...
        $dataCategory = Server_Category::where('module','catalog')->where('status','<>','0')->where('id','<>',$id)->get();
        return view('admin.'.$this->module.'.create_edit')
            ->with('module', $this->module)
            ->with('page_breadcrumbs', $this->page_breadcrumbs)
            ->with('data', $data)->with('dataCategory',$dataCategory);
