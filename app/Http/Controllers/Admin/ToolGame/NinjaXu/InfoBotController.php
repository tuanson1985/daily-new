...
class InfoBotController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if( $this->module!=""){
            $this->page_breadcrumbs[] = [
                'page' => route('admin.ninjaxu-info-bot.index'),
                'title' => __('Bán xu ninja shool - Bot')
            ];
        }
    }
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $model = NinjaXu_User::orderBy('ver', 'asc')->orderBy('server', 'asc');
            ...
            return $datatable = \datatables()->eloquent($model)
                ...
                ->addColumn('action', function ($row) {
                    $temp = "<a href=\"" . route('admin.ninjaxu-info-bot.edit', $row->id) . "\"  rel=\"$row->id\" class=\"m-portlet__nav-link btn m-btn m-btn--hover-info m-btn--icon m-btn--icon-only m-btn--pill \" title=\"Sửa\"><i class=\"la la-edit\"></i></a>";
        ...
        return view('admin.toolgame.ninjaxu.infobot.index')
    ...
    public function create()
    {
        ...
        return view('admin.toolgame.ninjaxu.infobot.create_edit')
    ...
    public function store(Request $request)
    {
        ...
        $item=NinjaXu_User::create($input);
    ...
    {
        //$datatable = NinjaXu_User::findOrFail($id);
        //return view('admin.toolgame.ninjaxu.infobot.show', compact('datatable'));
    }
    ...
    public function edit($id)
    {
        ...
        $data = NinjaXu_User::query()->findOrFail($id);
        return view('admin.toolgame.ninjaxu.infobot.create_edit', compact('data'))
            ->with('module', $this->module)
            ->with('page_breadcrumbs', $this->page_breadcrumbs);
    ...
    public function update(Request $request,$id)
    {
        ...
        $item = NinjaXu_User::findOrFail($id);
    ...
    public function destroy(Request $request)
    {
        ...
        NinjaXu_User::query()->whereIn('id',$input)->delete();
