...
class UserNapController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if( $this->module!=""){
            $this->page_breadcrumbs[] = [
                ...
                'title' => __('Bán vàng NRO - Thông tin bot nạp')
            ];
        }
    }
    ...
    {
        //$datatable = Bot_UserNap::findOrFail($id);
    ...
    public function edit($id)
    {
        ...
        $data = Bot_UserNap::findOrFail($id);
    ...
    {
        $item = Bot_UserNap::findOrFail($id);
        $input = $request->all();
        $item->update($input);
    ...
    public function destroy(Request $request)
    {
        ...
        Bot_UserNap::whereIn('id',$input)->delete();
