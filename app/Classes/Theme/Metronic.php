...
class Metronic
{
    ...
    public static function initThemes()
    {
        ...
        $themes[] = 'assets/backend/themes/css/themes/layout/header/base/'.config('layout.header.self.theme').'.css';
        $themes[] = 'assets/backend/themes/css/themes/layout/header/menu/'.config('layout.header.menu.desktop.submenu.theme').'.css';
        $themes[] = 'assets/backend/themes/css/themes/layout/aside/'.config('layout.aside.self.theme').'.css';

        if (config('layout.aside.self.display')) {
            $themes[] = 'assets/backend/themes/css/themes/layout/brand/'.config('layout.brand.self.theme').'.css';
        } else {
            $themes[] = 'assets/backend/themes/css/themes/layout/brand/'.config('layout.header.self.theme').'.css';
        }
        $themes[] ='assets/backend/themes/css/override.css';
