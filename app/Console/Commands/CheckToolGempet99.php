...
class CheckToolGempet99 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'checkToolGempet99:cron';
...
//            \File::append($path.Carbon::now()->format('Y-m-d').".txt",$txt."\n");
            ...
            if(!Cache::has('CHECK_TOOL_GAME_PET99_ROBLOX')){

                $message="[" . Carbon::now() . "] Tool gem pet 99 lỗi vui lòng kiểm tra lại! - ".' Thông báo từ '.config('app.url');
